...
from src.e2efix.app import run_e2e_mode, save_structure_pdb, save_trajectory
from src.e2efix.dataset import (
...
def test_e2e_mode(device):
    ...
    import os
    output_dir = f"test_outputs/e2efix_{pocket_id}"
...
def test_e2e_mode_with_dataset(device):
    ...
    from src.e2efix.dataset import E2EDataset
    ...
    e2e_checkpoint = pick_latest(['checkpoints/*e2efix*/*.ckpt'])
