...
def init_ligand_coords_features(int_index, receptor_atoms, ligand_fixed_atoms, ligand_size):
    ...
    Returns:
        dict with features including 'h', 'z', 'mask'
    """
...
def build_pair_features(int_index, receptor_atoms, ligand_size):
    ...
    Returns:
        numpy array of shape (n, n, 2) with [is_same_residue, is_interaction] features
    """
...
class ContDataset(Dataset):
    ...
    def features_to_tensors(features):
        ...
        Args:
            features: dict with keys 'x', 'h', 'z', 'mask', 'seq_mask', 'pair_mask'
        ...
        return {
            ...
            'mask': torch.tensor(features['mask'], dtype=torch.long),
    ...
    def collate_fn(batch_data):
        ...
        Args:
            batch_data: List of dicts, each with keys 'x', 'h', 'z', 'mask'
        ...
        Returns:
            Dict with batched and padded tensors:
                ...
                - fix_mask: [batch_size, max_n] - mask for fixed atoms (1=fixed, 0=sample)
        """
        ...
        fix_mask_batch = torch.zeros(batch_size, max_n, dtype=torch.long)  # 1 for fixed, 0 for sample
        ...
        for i, data in enumerate(batch_data):
            ...
            fix_mask_batch[i, :n] = data['mask']  # Copy fix mask
        ...
        return {
            ...
            'mask': fix_mask_batch,  # Keep 'mask' as key for compatibility with model
        }
